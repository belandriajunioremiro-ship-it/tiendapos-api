...
return [
    ...
    'documentations' => [
        'default' => [
            'api' => [
                'title' => 'TiendaPOS API - Multi-País LATAM',
            ],
    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            /**
             * analyser: supports both PHP 8 attributes and PHPDoc annotations.
             */
        ...
        'securityDefinitions' => [
            'securitySchemes' => [
                ...
                */
                ...
                'sanctum' => [
                    'type' => 'http',
                    'description' => 'Enter your Sanctum token. Prefix with "Bearer " in the Authorization header.',
                    'scheme' => 'bearer',
                    'bearerFormat' => 'JWT',
                ],
                */
