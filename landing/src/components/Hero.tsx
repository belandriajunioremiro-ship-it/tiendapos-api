    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 pt-24 pb-20 md:pt-28 md:pb-24">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          <a
            href="#planes"
            className="group inline-flex items-center gap-2.5 rounded-full bg-gradient-to-r from-violet-500 to-violet-700 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-violet-500/30 transition-all hover:shadow-xl hover:shadow-violet-500/40"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            className="inline-flex items-center gap-2.5 rounded-full border-2 border-violet-200 px-8 py-3.5 text-base font-semibold text-violet-600 no-underline transition-all hover:border-violet-500 hover:bg-violet-50"
          >
