...
<body>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <a href="https://wa.me/584247253544" target="_blank" class="wa-link" onclick="closeMenu()">
    ...
    <nav>
        <div class="nav-inner">
            ...
            <div class="nav-links">
                ...
                <a href="https://wa.me/584247253544" target="_blank" style="display:inline-flex;align-items:center;gap:0.4rem;background:#25d366;color:#fff!important;padding:0.45rem 1rem;border-radius:50px;font-size:0.8rem;font-weight:600">
    ...
    <div class="container">
        ...
        <a href="https://wa.me/584247253544" target="_blank" class="wa-float" aria-label="WhatsApp">
